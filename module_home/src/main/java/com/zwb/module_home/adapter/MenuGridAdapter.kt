...
class MenuGridAdapter(context: Context, page: Int) : RecyclerView.Adapter<MenuGridAdapter.MenuViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MenuViewHolder, position: Int) {
        ...
        holder.itemView.item_menu_title.text = MENU_TITLES[position]
    }
