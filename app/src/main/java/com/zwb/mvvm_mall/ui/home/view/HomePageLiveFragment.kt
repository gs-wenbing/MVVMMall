...
class HomePageLiveFragment : BaseVMFragment<HomeViewModel>(){

    var mAdapter = PagerLiveAdapter(R.layout.item_goods_big_layout,null)
    ...
    override fun initDataObserver() {
        ...
        mViewModel.mRecyclerGoods2.observe(viewLifecycleOwner, Observer {
