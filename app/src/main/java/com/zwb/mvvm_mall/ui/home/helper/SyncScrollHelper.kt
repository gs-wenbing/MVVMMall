package com.zwb.mvvm_mall.ui.home.helper
...
import com.zwb.mvvm_mall.common.utils.getScreenWidth
import com.zwb.mvvm_mall.common.utils.getStatusBarHeight
import com.zwb.mvvm_mall.common.view.recyclerview.ParentRecyclerView
...
class SyncScrollHelper(mainFragment: HomeFragment) {
    ...
    private val toolbarHeight = activity.dp2px(50f)
    private var screenHeight = activity.getScreenWidth()
    private var searchBarHeight = activity.dp2px(46f)
